...
public class ServerResponse {
    ...
    public ServerResponse(int id, String brand, String name, String price, String price_sign, String currency, String image_link, String product_link, String website_link, String description, String rating, String category, String product_type, List<String> tag_list, Date created_at, Date updated_at, String product_api_url, String api_featured_image, List<ProductColor> product_colors) {
        this.id = id;
        this.brand = brand;
        this.name = name;
        this.price = price;
